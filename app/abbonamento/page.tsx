      ...
      <div className="mb-6 sm:mb-8 space-y-6">
        ...
        <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {plans.map((plan) => (
              ...
              >
                ...
                {isPlaceholderLink(plan.href) ? (
                  // The live-mode Payment Link is not in yet. Render the price,
                  // never a button that would 404. See lib/subscription.ts.
          ...
          <p className="mt-3 text-xs text-gray-400">
            {plans.some((plan) => isPlaceholderLink(plan.href))
              ? page.comingSoonNote
              : page.paymentNote}
          </p>
        </div>
